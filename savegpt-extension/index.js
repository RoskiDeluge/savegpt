...
function init() {
  ...
  document.body.addEventListener("keydown", (event) => {
    if (event.keyCode === 13) {
      showIfNotLoading(submitButton, saveButton);
    }
  });
  ...
  saveButton.addEventListener("click", async () => {
    ...
    isRequesting = true;
    saveButton.textContent = "Sharing...";
    ...
    setTimeout(() => {
      saveButton.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-3 h-3">
